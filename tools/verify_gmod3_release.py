...
def audit(baseline=None):
    ...
    assert page.index('## v0.8.0:')<page.index('## v0.7.9:')<page.index('## v0.7.8:')<page.index('## Previous release: v0.7.7')
    ...
    assert 'Demo Cart v3.0: GMod3 All-in-One' in first and '58' in first
    ...
    for name,count in [('demo-cart-v3.0-gmod3-all-in-one',58),('demo-cart-v3.0-gmod3-all-in-one-benchmark',65)]:
    ...
    measured=read('docs/benchmarks/gmod3-collection/interactive/results.json')
    ...
    features=read('docs/benchmarks/gmod3-features/results.json')
    ...
    paging=read('docs/benchmarks/gmod3-paging/results.json')
    ...
    report=dict(passed=True,version='0.8.0',images=images,interactive_entries=58,automatic_entries=65,
