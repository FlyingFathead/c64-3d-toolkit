...
def main():
    ...
    for row in load(ROOT):
        ...
        options=dict(tass=a.tass,cartconv=a.cartconv,outdir=ROOT/new.parent,stem=new.stem,
    ...
    if not a.only or 'cart_hifi' in a.only:
        ...
        build_hifi_cart.main(['--renderer','hors-render-v2','--tass',a.tass,'--cartconv',a.cartconv])
