...
case "${1:-}" in
  ...
  --version)
    ...
    ;;
  build|cart-stream|color-combo-test|inspect|import-obj|import-svg|generate-examples|test-examples|cartridge-smoke|cart-demos|cartridge-demo|doctor|list-shapes|list-objects)
