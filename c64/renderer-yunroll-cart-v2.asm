; yunroll-cart-v2: independent EasyFlash frame-streaming derivative.
...
dcl_first_mask_ok:
        ...
        lda lines_remaining
        bne dcl_decrement_low
        dec lines_remaining+1
dcl_decrement_low:
        dec lines_remaining
        lda lines_remaining
        ora lines_remaining+1
        bne dcl_loop
...
.endif
        ...
        .include "generated/cart-v2-helper.inc"
