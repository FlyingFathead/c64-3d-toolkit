; yunroll-cart-v6-scene: paged directory, 16-bit frames, paced presentation.
; V6 drawing and direct metadata loading with paged, paced scene playback.
; yunroll-cart-v6: faster, format-compatible EasyFlash vector renderer.
; Inherits V5 lossless picture reuse and full Y blocks, plus V4 inline dispatch.
...
.endif
        ...
        .include "generated/cart-v6-scene-helper.inc"
