; yunroll-cart-v8-scene: paged directory, 16-bit frames, paced presentation.
; V8 drawing and direct metadata loading with paged, paced scene playback.
; yunroll-cart-v8: selective-clear EasyFlash vector renderer.
; V8 adds tagged byte-clear spans. Inherits V6 X kernels/direct metadata and
...
.endif
        ...
        .include "generated/cart-v8-scene-helper.inc"
