; yunroll-cart-v5-scene: paged directory, 16-bit frames, paced presentation.
; Derived from V5; line rasterisation kernels are unchanged.
; yunroll-cart-v5: faster, format-compatible EasyFlash vector renderer.
; V5 additionally inlines line dispatch and tail-jumps from drawing kernels.
; Copies one bank-contained frame into $a000-$bfff, in interruptible 256-byte
; bursts. Old clear/colour metadata is cached for each of the three bitmaps.
...
.endif
        ...
        .include "generated/cart-v5-scene-helper.inc"
