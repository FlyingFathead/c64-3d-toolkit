; yunroll-cart-v3: faster, format-compatible EasyFlash vector renderer.
; Direct dispatch LUTs, counted run batches, Y fall-through, constant-time metadata skips.
...
.endif
        ...
        .include "generated/cart-v3-helper.inc"
