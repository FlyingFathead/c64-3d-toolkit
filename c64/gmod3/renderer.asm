; Experimental GMod3 HORS-V2 spinner. Frozen V10 core, independent backend.
; Mapping helpers and bank directory belong to c64/gmod3 and gmod3_stream.py.
; ROM visible at $37, RAM bitmap reads at $35; raster IRQ never banks ROM.
PREFER_RAM = 0
V9_BYTE_SPANS = 0
V5_REUSE_ENABLED = 0
FRAME_COUNT = 48
...
.endif
        ...
        .include "generated/gmod3-helper.inc"
...
v3_entry_lo = $4f00 ; direct literal pictures only
* = $5c00
.if PREFER_RAM == 0
