; yunroll-cart-v7-scene: paged directory, 16-bit frames, paced presentation.
; V7 drawing and direct metadata loading with paged, paced scene playback.
; yunroll-cart-v7: selective-clear EasyFlash vector renderer.
; V7 adds tagged byte-clear spans. Inherits V6 X kernels/direct metadata and
...
.endif
        ...
        .include "generated/cart-v7-scene-helper.inc"
