; -----------------------------------------------------------------------------
; EXPERIMENTAL yunroll-cart renderer reference source
; -----------------------------------------------------------------------------
; Cartridge-specific derivative of the v0.6.2 production yunroll renderer.
;
; This file is intentionally separate from renderer-yunroll.asm so EasyFlash
; streaming/memory-map work can diverge without changing the stable PRG path.
; Phase 1 keeps the implementation byte-for-byte equivalent below this header;
; later cartridge stages will replace the all-tables-resident assumptions.
; -----------------------------------------------------------------------------
