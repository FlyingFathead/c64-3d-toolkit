; V7 copy helpers in $4100-$42ff; dispatch high bytes occupy $4300-$43ff. Included after the existing $4000 colour reset.
.if * > $4100
    .error "colour helper overlaps cart-v7 helper"
.endif
* = $4100
cart_fetch_frame:
        ldx frame_index
...
; V7 retains four 64-byte sections, one index update per group.
...
cart_copy_count = $ee
.if * > $4300
    .error "cart helper overlaps v7 dispatch table"
.endif
