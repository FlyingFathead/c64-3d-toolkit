; c64-3d-toolkit EasyFlash demo menu / legacy-PRG launcher.
;
...
title_default:
    .text "C64 3D TOOLKIT 0.6.7 CARTRIDGE DEMO"
    .byte 0
title_fancy:
...
.if * > $d000
    .error "EasyFlash demo runtime exceeds reserved $C800-$CFFF RAM"
.endif
.fill $d000-*, $ff
