; V9 EasyFlash controls, with a PLAY ALL timer in menu-owned RAM at $c700.
;
...
.if * > $02f7
    .error "EasyFlash demo control code overlaps control variables at $02F7 (V9 exhibition flag)"
.endif
.fill $0300-*, $ff
