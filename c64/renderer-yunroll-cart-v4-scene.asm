; yunroll-cart-v4-scene: paged directory, 16-bit frames, paced presentation.
; Derived from V4; line rasterisation kernels are unchanged.
; yunroll-cart-v4: faster, format-compatible EasyFlash vector renderer.
; V4 additionally inlines line dispatch and tail-jumps from drawing kernels.
...
.endif
        ...
        .include "generated/cart-v4-scene-helper.inc"
