...
| V3 metallic, interactive | 128 | 14.20 | 296,092 | 377,632 |
...
| --- | ---: | ---: |
| Black, cycling off | **14.20** | 12.10 |
| Blue, cycling off | **13.66** | 12.13 |
| Automatic, 50 ticks | **13.40** | 11.86 |
...
| Presentation / setting | Displayed FPS | Longest hold (ms) | Stars | HUD | Speed level |
| --- | ---: | ---: | --- | --- | ---: |
| gradient-stars | 15.97 | 83.32 | on | shown | 3 |
| gradient-no-stars | 18.25 | 62.96 | off | shown | 3 |
| solid-no-stars | 18.51 | 63.92 | off | shown | 3 |
| solid-stars | 16.57 | 83.05 | on | shown | 3 |
| gradient-crawl-stars | 19.18 | 63.45 | on | shown | 3 |
| solid-crawl | **22.06** | 63.42 | off | shown | 3 |
| gradient-stars-cycle | 11.43 | 122.47 | on | shown | 3 |
| gradient-stars-hue | 14.37 | 83.39 | on | shown | 3 |
| card-spin | 13.97 | 83.21 | on | shown | 3 |
| card-crawl | 18.04 | 82.21 | on | shown | 3 |
| outline-spin | 16.31 | 82.20 | on | shown | 3 |
| outline-crawl | 18.98 | 80.69 | on | shown | 3 |
| slowest | 2.31 | 478.84 | on | shown | 0 |
| fastest | 15.71 | 82.48 | on | shown | 10 |
| gradient-stars-hud-hidden | 15.97 | 82.51 | on | hidden | 3 |
| gradient-no-stars-hud-hidden | 18.24 | 63.54 | off | hidden | 3 |

Starfield difference on this cart: **-12.46%** displayed throughput. This includes sprite setup and VIC-II DMA. Default speed is level 3; source/style, input, hue and background controls remain enabled in both rows.

Speed and HUD controls share a 2,048-byte reservation at $9000–$97ff. HUD switches use its second KiB without additional reserved RAM; hidden glyph rendering returns immediately. The starfield reuses the literal-only vector LUT allocation at $1700–$1fff and uses 192 bytes of sprite patterns. Opaque SAKU variants reserve another 2 KiB at $8800–$8fff for bounding-box masks and relocated star paths. Toggling an already included mode/effect adds no frame-stream ROM; additional precomputed presentations do consume ROM. See the manifests for actual code extents and total cartridge capacity.
...
| --- | ---: | ---: | ---: |
| stars-on | 1821.72 | 1799 | 1844 |
| stars-off | 32.00 | 32 | 32 |
| speed-poll-idle | 88.38 | 83 | 126 |
| effects-poll-idle | 86.03 | 82 | 125 |

VICE stopwatch, 32 calls per routine, including call/return; elapsed machine cycles. Help uses the existing Shift test. The HUD key-release latch adds six CPU cycles per ordinary unshifted poll when effects are included (three without them); no per-frame visibility branch is added to drawing. Help uses a separate 1 KiB text screen plus 1 KiB code reservation, pauses the producer/IRQ while open, and restores all three picture buffers and presentation state. The startup screen is excluded from these measurements.

HUD hidden versus shown, gradient-stars: **+0.00%** displayed throughput, same cartridge and default speed.

HUD hidden versus shown, gradient-no-stars: **-0.01%** displayed throughput, same cartridge and default speed.
...
| --- | ---: | ---: |
| excluded | **9.60 (tie)** | 170,815 |
| included-disabled | **9.60 (tie)** | 170,815 |
| included-enabled | 8.47 | 170,815 |
...
<!-- comparison-input-sha256: c35919bcda1c27e0cd5d479af84a3b43b9f70b98e2f6d583c6bb8647cbed9076 -->
