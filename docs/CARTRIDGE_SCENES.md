...
41.50 seconds for the scene in the recorded PAL VICE run. Its requested 16 FPS
...
```bash
python c643d.py build --no-config --renderer hors-render-v2-scene \
...
`--tass` and `--cartconv`. See [Blender targets](HORS_RENDER_V2.md) for
