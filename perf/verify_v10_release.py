#!/usr/bin/env python3
"""Verify built V10 menu pictures, authored scenes and native Marbles endings."""
...
def main():
    ...
    a=p.parse_args();out=ROOT/'logs/v10-release';out.mkdir(parents=True,exist_ok=True)
    jobs=[]
    for crt in sorted((ROOT/'examples').rglob('*v10*.crt')):
